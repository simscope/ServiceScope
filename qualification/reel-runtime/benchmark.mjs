...
async function combineReports(root) {
  ...
  const report = {
    schemaVersion: 'servicescope-reel-runtime-memory-qualification-v1',
    baselineSha: 'c7e8912a05112685a727498915fd63ca95631212',
    runner,
    container: {
      baseImage,
...
function markdownReport(report) {
  ...
  return `# ServiceScope Reel runtime memory qualification
