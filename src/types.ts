...
export type CompanyPortalAccessPage = 'jobInbox' | 'jobs' | 'allJobs' | 'debtors' | 'calendar' | 'materials' | 'warehouse' | 'tasks' | 'map' | 'email' | 'finances' | 'aiBusiness' | 'knowledge' | 'import' | 'portal' | 'onboarding';
