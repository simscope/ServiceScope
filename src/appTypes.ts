...
export type ClientPage = 'onboarding' | 'jobInbox' | 'jobs' | 'allJobs' | 'debtors' | 'calendar' | 'materials' | 'warehouse' | 'tasks' | 'map' | 'email' | 'finances' | 'aiBusiness' | 'knowledge' | 'import' | 'portal';
