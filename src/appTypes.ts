...
export type ClientPage = 'onboarding' | 'jobInbox' | 'jobs' | 'allJobs' | 'debtors' | 'calendar' | 'materials' | 'warehouse' | 'tasks' | 'map' | 'email' | 'finances' | 'aiBusiness' | 'aiAssistant' | 'knowledge' | 'import' | 'portal';
