...
export const companyPortalAccessPages: AccessPageDefinition[] = [
  ...
  { page: 'warehouse', label: 'Warehouse', detail: 'Inventory locations, stock, suppliers, and movements' },
  ...
  { page: 'aiBusiness', label: 'Business Analyst', detail: 'Business KPIs, payroll analytics, receivables, and customer opportunities' },
