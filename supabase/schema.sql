...
revoke all on function company_ai_voice_text_valid(text, integer, boolean) from public;
revoke all on function company_ai_voice_text_array_valid(text[], integer, integer) from public;
revoke all on function company_ai_channel_defaults_valid(jsonb) from public;
