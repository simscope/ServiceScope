-- Fix Job return movement reference_id.
-- Some production job_materials rows can expose id as text, while inventory_movements.reference_id is uuid.
-- Return movements should reference the original job_issue movement UUID.
